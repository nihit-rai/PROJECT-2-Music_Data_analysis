...
hadoop fs -get /user/hive/warehouse/musicdata.db/enriched_data/batchid=$batchid/status=pass/* $VALIDDIR
hadoop fs -get /user/hive/warehouse/musicdata.db/enriched_data/batchid=$batchid/status=fail/* $INVALIDDIR
